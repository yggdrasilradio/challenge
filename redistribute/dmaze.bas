...
11PRINT"$ ";:ATTR2,0:PRINT"Gold":PRINT:ATTR5,0:PRINT"* Use arrow keys to move.":PRINT"* Avoid the dragons.":PRINT"* Collect all the gold to win.":PRINT"* Collect swords to fight the dragons.":PRINT"* One sword will kill one dragon."
12PRINT"* Swords magically vanish after use.":PRINT"* Good luck!":ATTR2,0:LOCATE0,23:PRINT"Generating maze:";:MW=19:MH=11:T=MW*MH:DIMA$(MH*2+1):R1$="+":R2$="!":FORI=1TO MW:R1$=R1$+"---+":R2$=R2$+" X !"
...
51NEXTI:ATTR2,0:S=0:LOCATE0,23:PRINT"Gold: 0";:I$="":LOCATE34,23:PRINT"Swords: 0";:X=3:Y=2:LOCATEX-1,Y-1:ATTR7,0:PRINT"O";:DIMX(2),Y(2),DX(2),DY(2):FORI=1TO2:READX(I),Y(I),DX(I),DY(I):LOCATEX(I)-1,Y(I)-1
...
106IFC$="^" THENI$=I$+"^":LOCATE41,23:ATTR2,0:PRINTLEN(I$);:MID$(A$(NY),NX,1)=" ":M$="Found sword":GOSUB9000
...
6012RUN
7000LOCATEX-1,Y-1:IFLEN(I$)>0 THENI$=LEFT$(I$,LEN(I$)-1):LOCATE41,23:ATTR2,0:PRINTLEN(I$);:X(I)=0:M$="Killed dragon":PALETTE0,63:GOSUB9000:LOCATEX-1,Y-1:ATTR7,0:PRINT"O";:RETURN
