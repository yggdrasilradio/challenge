...
51NEXTI:ATTR2,0:S=0:LOCATE0,23:PRINT"Gold: 0";:X=3:Y=2:LOCATEX-1,Y-1:ATTR7,0:PRINT"O";:DIMX(2),Y(2),DX(2),DY(2):FORI=1TO2:READX(I),Y(I),DX(I),DY(I):LOCATEX(I)-1,Y(I)-1:ATTR7,0:PRINT"&";:NEXTI:I$=""
...
108IFS=100 THENM$="You have won!":GOSUB9000
120S$=INKEY$:IFS$="" THENGOTO120
121RUN
122GOSUB2000:GOTO100
...
7000LOCATEX-1,Y-1:IFI$="^" THENI$="":X(I)=0:M$="Killed dragon":GOSUB9000:LOCATEX-1,Y-1:ATTR7,0:PRINT"O";:RETURN
7001LOCATEX-1,Y-1:ATTR7,0:PRINT"&";:M$="You died":GOSUB9000
...
9000LOCATELEN(A$(1))-LEN(M$),23:ATTR2,0:PRINTM$;:RETURN
