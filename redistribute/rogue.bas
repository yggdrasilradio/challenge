...
10CLS:ATTR2,0:PRINT"Generating maze";:MW=19:MH=11:T=MW*MH:DIMA$(MH*2+1):R1$="+":R2$="!":FORI=1TO MW:R1$=R1$+"---+":R2$=R2$+" X !":NEXTI:FORI=1TO MH*2+1:IFI AND1 THENA$(I)=R1$ ELSEA$(I)=R2$
...
30S=S+1:SX(S)=X:SY(S)=Y:MID$(A$(Y),X,1)=" ":N=N-1:IFN>0 THENPRINT".";:GOTO20
