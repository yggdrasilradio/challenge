...
10CLS:ATTR2,0:PRINT"Generating maze";:MW=19:MH=11:DIMA$(MH*2+1):R1$="+":R2$="!":FORI=1TO MW:R1$=R1$+"---+":R2$=R2$+" X !":NEXTI:FORI=1TO MH*2+1:IFI AND1 THENA$(I)=R1$ ELSEA$(I)=R2$
...
31CLS:ATTR5,0:FORI=1TO MH*2+1:PRINTA$(I):NEXTI:ATTR7,0:FORI=1TO10
