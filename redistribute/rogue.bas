...
10CLS:ATTR0,0:PRINT"*** DRAGONMAZE ***":PRINT:ATTR7,0:PRINT"O ";:ATTR2,0:PRINT"Player":ATTR7,0:PRINT"& ";:ATTR2,0:PRINT"Dragon":ATTR7,0:PRINT"^ ";:ATTR2,0:PRINT"Sword":ATTR7,0:PRINT"$ ";:ATTR2,0:PRINT"Gold"
11PRINT:ATTR5,0:PRINT"* Use arrow keys to move.":PRINT"* Avoid the dragons.":PRINT"* Collect all the gold to win.":PRINT"* A sword will kill one dragon.":PRINT"* Good luck!":ATTR2,0:LOCATE0,23:PRINT"Generating maze:";
12MW=19:MH=11:T=MW*MH:DIMA$(MH*2+1):R1$="+":R2$="!":FORI=1TO MW:R1$=R1$+"---+":R2$=R2$+" X !":NEXTI:FORI=1TO MH*2+1:IFI AND1 THENA$(I)=R1$ ELSEA$(I)=R2$
