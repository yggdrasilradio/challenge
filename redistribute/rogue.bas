1WIDTH80:POKE&HFFD9,0:CLEAR3000:X=RND(-TIMER):ONBRKGOTO1000:PALETTE12,63:PALETTE13,0
...
31FORI=1TO6:READY,X,A$:MID$(A$(Y),X,1)=A$:NEXTI:CLS:FORI=1TO MH*2+1:PRINTA$(I):NEXTI:S=0:LOCATE0,23:PRINT"GOLD: 0";:X=3:Y=2:LOCATEX-1,Y-1:PRINT"O";:DIMX(2),Y(2),DX(2),DY(2):FORI=1TO2:READX(I),Y(I),DX(I),DY(I)
32LOCATEX(I)-1,Y(I)-1:PRINT"&";:NEXTI:I$=""
